...
## Phase 2: Stack allocations in hot loop
...
## Phase 3: Deduplicate CameraProjection
...
## Phase 4: Hoist eye-independent work out of map eye loop
...
- **F1**: `transform_vertices()` in map view should be called once outside the eye loop (matching SceneView pattern).
