...
pub use style::{
    adjust_w_thickness, compute_vertex_alpha, truncate_segment_to_slice, DEFAULT_EYE_SEPARATION,
    DEFAULT_PROJECTION_DISTANCE, DEFAULT_W_COLOR_INTENSITY, DEFAULT_W_THICKNESS, MIN_VERTEX_ALPHA,
