...
pub use style::{
    adjust_w_thickness, compute_vertex_alpha, DEFAULT_EYE_SEPARATION, DEFAULT_PROJECTION_DISTANCE,
    DEFAULT_W_COLOR_INTENSITY, DEFAULT_W_THICKNESS, MIN_VERTEX_ALPHA, W_THICKNESS_DRAG_SENSITIVITY,
    W_THICKNESS_MAX, W_THICKNESS_MIN,
};
